...
- Para o posicionamento dos comandos na faixa de opções do Office:
    ...
    - Não adicione botões supérfluos para aumentar o estado real do seu suplemento.
     ...
     > [!NOTE]
     > Os suplementos que ocupam muito espaço podem não passar na [Validação do AppSource](https://docs.microsoft.com/pt-br/office/dev/store/validation-policies).
