...
Construiremos um exemplo de guias contextuais blob JSON passo a passo. (O esquema completo da guia contextual JSON estádynamic-ribbon.schema.js[ em](https://developer.microsoft.com/json-schemas/office-js/dynamic-ribbon.schema.json). Esse link pode não estar funcionando no período de visualização para guias contextuais. Se o link não estiver funcionando, você poderá encontrar o rascunho mais recente do esquema no [rascunho dynamic-ribbon.schema.jsem](https://github.com/OfficeDev/testing-assets/tree/master/jsonschema/dynamic-ribbon/1.0/dynamic-ribbon.schema.json).) Se você estiver trabalhando no Visual Studio Code, poderá usar esse arquivo para obter IntelliSense e validar seu JSON. Para obter mais informações, [consulte Editing JSON with Visual Studio Code - JSON schemas and settings](https://code.visualstudio.com/docs/languages/json#_json-schemas-and-settings).
