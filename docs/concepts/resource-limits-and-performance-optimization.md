...
Saiba mais em [Implantar o Painel de Telemetria](http://msdn.microsoft.com/pt-br/library/f69cde72-689d-421f-99b8-c51676c77717%28Office.15%29.aspx) e [Solução de problemas de arquivos do Office e soluções personalizadas com o log de telemetria](http://msdn.microsoft.com/library/ef88e30e-7537-488e-bc72-8da29810f7aa%28Office.15%29.aspx).
...
- 
  [Limites de ativação e da API do JavaScript API para suplementos do Outlook](https://docs.microsoft.com/pt-br/outlook/add-ins/limits-for-activation-and-javascript-api-for-outlook-add-ins)
