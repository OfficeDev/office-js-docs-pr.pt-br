...
- Microsoft Edge deve ser instalado, mas não precisa ser o navegador padrão. Para dar Office suplementos, o cliente Office que atua como host usa componentes do navegador que fazem parte do Microsoft Edge.

  > [!NOTE]
  >
  > - Estritamente falando, é possível desenvolver suplementos em um computador que tenha o Internet Explorer 11 instalado, mas não Microsoft Edge. No entanto, o IE é usado para executar suplementos somente em determinadas combinações mais antigas de Windows e Office versões. Consulte [Navegadores usados pelos Suplementos do Office](browsers-used-by-office-web-add-ins.md) para obter mais detalhes. Não recomendamos usar ambientes antigos como seu ambiente de desenvolvimento de suplemento principal. No entanto, se for provável que você tenha clientes de seu suplemento que estejam trabalhando nessas combinações mais antigas, recomendamos que você seja compatível com o Internet Explorer. Para obter mais informações, consulte [Suporte ao Internet Explorer 11](../develop/support-ie-11.md).
...
|:-----|:-----|:-----|:-----|:-----|
|Outlook no Android|- Android tablets<br>- Android smartphones|– Android KitKat 4.4 ou posterior|Na atualização mais recente do Microsoft 365 Apps para Pequenos e Médios negócios ou Exchange Online|Navegador não aplicável. Use o aplicativo nativo para Android.<sup> 1</sup>|
...
|Outlook na Web (moderno)<sup>2</sup>|– iPad 2 ou posterior<br>- Android tablets |– iOS 5 ou posterior<br>– Android KitKat 4.4 ou posterior|No Microsoft 365, Exchange Online|- Microsoft Edge<br>- Chrome<br>- Firefox<br>– Safari|
|Outlook na Web (clássico)|– iPhone 4 ou posterior<br>– iPad 2 ou posterior<br>- iPod Touch 4 ou posterior|– iOS 5 ou posterior|No local Exchange Server 2013 ou<sup>posterior 3</sup>|– Safari|
...
>
> <sup>2</sup> Os Outlook na Web modernos em iPhone e Android smartphones não são mais necessários ou estão disponíveis para teste Outlook suplementos.
>
> <sup>Três suplementos</sup> não têm suporte no Outlook no Android, no iOS e na Web móvel moderna com contas Exchange locais.
