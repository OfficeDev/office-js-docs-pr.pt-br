...
| | | [Participante do Compromisso](/javascript/api/outlook/office.appointmentread?view=outlook-js-preview&preserve-view=true#isAllDayEvent) | Boleano | [Visualização](outlook-requirement-set-preview.md) |
