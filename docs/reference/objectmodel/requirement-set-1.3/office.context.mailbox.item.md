...
#### <a name="attachments-arrayattachmentdetailsjavascriptapioutlook13officeattachmentdetails"></a>anexos: Array. <[AttachmentDetails](/javascript/api/outlook_1_3/office.attachmentdetails)>
...
#### <a name="bcc-recipientsjavascriptapioutlook13officerecipients"></a>CCO: [destinatários](/javascript/api/outlook_1_3/office.recipients)
...
#### <a name="body-bodyjavascriptapioutlook13officebody"></a>corpo: [Body](/javascript/api/outlook_1_3/office.body)
...
#### <a name="cc-arrayemailaddressdetailsjavascriptapioutlook13officeemailaddressdetailsrecipientsjavascriptapioutlook13officerecipients"></a>[destinatários](/javascript/api/outlook_1_3/office.recipients) [EmailAddressDetails](/javascript/api/outlook_1_3/office.emailaddressdetails)>|CC: Array. <
...
#### <a name="end-datetimejavascriptapioutlook13officetime"></a>fim: data | [Tempo](/javascript/api/outlook_1_3/office.time)
...
O exemplo a seguir define a hora de término de um compromisso usando o método [`setAsync`](/javascript/api/outlook_1_3/office.time#setasync-datetime--options--callback-) do objeto `Time`.
...
*   Data | [Hora](/javascript/api/outlook_1_3/office.time)
...
#### <a name="location-stringlocationjavascriptapioutlook13officelocation"></a>local: cadeia de caracteres | [Local](/javascript/api/outlook_1_3/office.location)
...
*   Cadeia de caracteres | [Localização](/javascript/api/outlook_1_3/office.location)
...
#### <a name="optionalattendees-arrayemailaddressdetailsjavascriptapioutlook13officeemailaddressdetailsrecipientsjavascriptapioutlook13officerecipients"></a>optionalAttendees: [EmailAddressDetails](/javascript/api/outlook_1_3/office.emailaddressdetails)>|[](/javascript/api/outlook_1_3/office.recipients) de matriz. <
...
#### <a name="organizer-emailaddressdetailsjavascriptapioutlook13officeemailaddressdetails"></a>organizador: [EmailAddressDetails](/javascript/api/outlook_1_3/office.emailaddressdetails)
...
#### <a name="requiredattendees-arrayemailaddressdetailsjavascriptapioutlook13officeemailaddressdetailsrecipientsjavascriptapioutlook13officerecipients"></a>requiredAttendees: [EmailAddressDetails](/javascript/api/outlook_1_3/office.emailaddressdetails)>|[](/javascript/api/outlook_1_3/office.recipients) de matriz. <
...
#### <a name="sender-emailaddressdetailsjavascriptapioutlook13officeemailaddressdetails"></a>remetente: [EmailAddressDetails](/javascript/api/outlook_1_3/office.emailaddressdetails)
...
#### <a name="start-datetimejavascriptapioutlook13officetime"></a>Início: data | [Tempo](/javascript/api/outlook_1_3/office.time)
...
#### <a name="subject-stringsubjectjavascriptapioutlook13officesubject"></a>subject: cadeia de caracteres | [Assunto](/javascript/api/outlook_1_3/office.subject)
...
#### <a name="to-arrayemailaddressdetailsjavascriptapioutlook13officeemailaddressdetailsrecipientsjavascriptapioutlook13officerecipients"></a>para: Array. <[](/javascript/api/outlook_1_3/office.emailaddressdetails)>|[destinatários](/javascript/api/outlook_1_3/office.recipients) EmailAddressDetails
