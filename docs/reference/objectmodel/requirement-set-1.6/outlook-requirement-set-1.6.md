...
- Adicionado [Office.context.mailbox.userProfile.accountType](/javascript/api/outlook/office.userprofile?view=outlook-js-1.6&preserve-view=true#outlook-office-userprofile-accounttype-member): adiciona um novo membro ao perfil de usuário, que indica o tipo de conta do usuário.
