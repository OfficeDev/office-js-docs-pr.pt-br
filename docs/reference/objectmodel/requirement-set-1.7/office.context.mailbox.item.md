...
#### <a name="attachments-arrayattachmentdetailsjavascriptapioutlookofficeattachmentdetailsviewoutlook-js-17"></a>anexos: Matriz.<[AttachmentDetails](/javascript/api/outlook/office.attachmentdetails?view=outlook-js-1.7)>
...
#### <a name="bcc-recipientsjavascriptapioutlookofficerecipientsviewoutlook-js-17"></a>cco :[Destinatários](/javascript/api/outlook/office.recipients?view=outlook-js-1.7)
...
Por padrão, a coleção é limitada a um máximo de 100 membros. No entanto, no Windows e no Mac, os seguintes limites se aplicam.

- Obter máximo de 500 membros.
- Defina um máximo de 100 membros por chamada, até 500, no total.

##### <a name="type"></a>Tipo

*   [Destinatários](/javascript/api/outlook/office.recipients?view=outlook-js-1.7)
...
#### <a name="body-bodyjavascriptapioutlookofficebodyviewoutlook-js-17"></a>corpo: [Corpo](/javascript/api/outlook/office.body?view=outlook-js-1.7)
...
A propriedade `cc` retorna uma matriz que contém um objeto `EmailAddressDetails` para cada destinatário listado na linha **Cc** da mensagem. Por padrão, a coleção é limitada a um máximo de 100 membros. No entanto, no Windows e no Mac, é possível obter o máximo de 500 membros.
...
A propriedade `cc` retorna um objeto `Recipients` que fornece métodos para obter ou atualizar os destinatários na linha **Cc** da mensagem. Por padrão, a coleção é limitada a um máximo de 100 membros. No entanto, no Windows e no Mac, os seguintes limites se aplicam.
...
#### <a name="end-datetimejavascriptapioutlookofficetimeviewoutlook-js-17"></a>fim: Data|[Hora](/javascript/api/outlook/office.time?view=outlook-js-1.7)
...
O exemplo a seguir define a hora de término de um compromisso usando o método [`setAsync`](/javascript/api/outlook/office.time?view=outlook-js-1.7#setasync-datetime--options--callback-) do objeto `Time`.
...
*   Data | [Hora](/javascript/api/outlook/office.time?view=outlook-js-1.7)
...
#### <a name="from-emailaddressdetailsjavascriptapioutlookofficeemailaddressdetailsviewoutlook-js-17fromjavascriptapioutlookofficefromviewoutlook-js-17"></a>de: [EmailAddressDetails](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.7)|[de](/javascript/api/outlook/office.from?view=outlook-js-1.7)
...
*   [EmailAddressDetails](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.7) | [de](/javascript/api/outlook/office.from?view=outlook-js-1.7)
...
#### <a name="location-stringlocationjavascriptapioutlookofficelocationviewoutlook-js-17"></a>Local: Cadeia de caracteres[Local](/javascript/api/outlook/office.location?view=outlook-js-1.7)
...
*   Cadeia de caracteres | [Localização](/javascript/api/outlook/office.location?view=outlook-js-1.7)
...
A propriedade `optionalAttendees` retorna uma matriz que contém um objeto `EmailAddressDetails` para cada participante opcional da reunião. Por padrão, a coleção é limitada a um máximo de 100 membros. No entanto, no Windows e no Mac, é possível obter o máximo de 500 membros.
...
A propriedade `optionalAttendees` retorna um objeto `Recipients` que fornece métodos para obter ou atualizar os participantes opcionais de uma reunião. Por padrão, a coleção é limitada a um máximo de 100 membros. No entanto, no Windows e no Mac, os seguintes limites se aplicam.
...
#### <a name="organizer-emailaddressdetailsjavascriptapioutlookofficeemailaddressdetailsviewoutlook-js-17organizerjavascriptapioutlookofficeorganizerviewoutlook-js-17"></a>organizador: [](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.7)|[organizador](/javascript/api/outlook/office.organizer?view=outlook-js-1.7) EmailAddressDetails

Obtém o endereço de email do organizador de uma reunião especificada.

##### <a name="read-mode"></a>Modo de leitura

A `organizer` propriedade retorna um objeto [EmailAddressDetails](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.7) que representa o organizador da reunião.
...
*   [](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.7) | [Organizador](/javascript/api/outlook/office.organizer?view=outlook-js-1.7) EmailAddressDetails
...
A `recurrence` propriedade retorna um objeto [Recurrence](/javascript/api/outlook/office.recurrence?view=outlook-js-1.7) que representa a recorrência do compromisso. Isso está disponível para compromissos e solicitações de reunião.
...
A `recurrence` propriedade retorna um objeto [Recurrence](/javascript/api/outlook/office.recurrence?view=outlook-js-1.7) que fornece métodos para gerenciar a recorrência do compromisso. Isso está disponível para compromissos.
...
* [Recorrência](/javascript/api/outlook/office.recurrence?view=outlook-js-1.7)
...
#### <a name="requiredattendees-arrayemailaddressdetailsjavascriptapioutlookofficeemailaddressdetailsviewoutlook-js-17recipientsjavascriptapioutlookofficerecipientsviewoutlook-js-17"></a>requiredAttendees: Matriz.<[EmailAddressDetails](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.7)>|[Destinatários](/javascript/api/outlook/office.recipients?view=outlook-js-1.7)
...
A propriedade `requiredAttendees` retorna uma matriz que contém um objeto `EmailAddressDetails` para cada participante obrigatório da reunião. Por padrão, a coleção é limitada a um máximo de 100 membros. No entanto, no Windows e no Mac, é possível obter o máximo de 500 membros.
...
A propriedade `requiredAttendees` retorna um objeto `Recipients` que fornece métodos para obter ou atualizar os participantes obrigatórios de uma reunião. Por padrão, a coleção é limitada a um máximo de 100 membros. No entanto, no Windows e no Mac, os seguintes limites se aplicam.
...
#### <a name="sender-emailaddressdetailsjavascriptapioutlookofficeemailaddressdetailsviewoutlook-js-17"></a>remetente :[EmailAddressDetails](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.7)
...
#### <a name="start-datetimejavascriptapioutlookofficetimeviewoutlook-js-17"></a>início: Data|[Hora](/javascript/api/outlook/office.time?view=outlook-js-1.7)
...
O exemplo a seguir define a hora de início de um compromisso no modo de composição usando o método [`setAsync`](/javascript/api/outlook/office.time?view=outlook-js-1.7#setasync-datetime--options--callback-) do objeto `Time`.
...
#### <a name="subject-stringsubjectjavascriptapioutlookofficesubjectviewoutlook-js-17"></a>Assunto: Cadeia de caracteres|[Assunto](/javascript/api/outlook/office.subject?view=outlook-js-1.7)
...
#### <a name="to-arrayemailaddressdetailsjavascriptapioutlookofficeemailaddressdetailsviewoutlook-js-17recipientsjavascriptapioutlookofficerecipientsviewoutlook-js-17"></a>para: Matriz.<[EmailAddressDetails](/javascript/api/outlook/office.emailaddressdetails?view=outlook-js-1.7)>|[Destinatários](/javascript/api/outlook/office.recipients?view=outlook-js-1.7)
...
A propriedade `to` retorna uma matriz que contém um objeto `EmailAddressDetails` para cada destinatário listado na linha **Para** da mensagem. Por padrão, a coleção é limitada a um máximo de 100 membros. No entanto, no Windows e no Mac, é possível obter o máximo de 500 membros.
...
A propriedade `to` retorna um objeto `Recipients` que fornece métodos para obter ou atualizar os destinatários na linha **Para** da mensagem. Por padrão, a coleção é limitada a um máximo de 100 membros. No entanto, no Windows e no Mac, os seguintes limites se aplicam.
...
Tipo: [Entities](/javascript/api/outlook/office.entities?view=outlook-js-1.7)
...
|Nome|Tipo|Descrição|
|---|---|---|
|`entityType`|[Office.MailboxEnums.EntityType](/javascript/api/outlook/office.mailboxenums.entitytype?view=outlook-js-1.7)|Um dos valores de enumeração de EntityType.|
