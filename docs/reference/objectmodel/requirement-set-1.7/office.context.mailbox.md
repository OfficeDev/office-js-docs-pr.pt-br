...
|`restVersion`| [Office.MailboxEnums.RestVersion](/javascript/api/outlook_1_7/office.mailboxenums.restversion)|Um valor indicando a versão da API REST do Outlook com a qual a ID convertida será usada.|
...
|Nome| Tipo| Descrição|
|---|---|---|
|`input`| [LocalClientTime](/javascript/api/outlook_1_7/office.LocalClientTime)|O valor de hora local a ser convertido.|
