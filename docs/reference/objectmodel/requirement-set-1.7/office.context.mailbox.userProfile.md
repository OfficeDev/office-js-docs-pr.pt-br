...
Obtém o tipo de conta do usuário associada à caixa de correio. Os valores possíveis são listados na tabela a seguir.
...
Obtém o endereço de e-mail SMTP do usuário.
