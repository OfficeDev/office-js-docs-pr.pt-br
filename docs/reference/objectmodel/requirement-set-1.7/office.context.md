...
description: Office. Membros do objeto context disponível para Outlook que usam conjunto de requisitos da API de Caixa de Correio 1.7.
ms.date: 12/03/2020
