...
ms.locfileid: "57093004"
---
# <a name="rule-element"></a>Elemento Rule

Especifica as regras de ativação que devem ser avaliadas para esse complemento de email contextual.

**Tipo de complemento:** Email (contextual)
