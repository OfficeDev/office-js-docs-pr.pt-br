...
---
# <a name="whats-new-in-excel-javascript-api-19"></a>Novidades na API JavaScript do Excel 1.9
...
||[tintAndShade](/javascript/api/excel/excel.rangefill#tintandshade)|Especifica um duplo que clareia ou escurece uma cor para Range Fill, o valor está entre -1 (mais escuro) e 1 (mais brilhante), com 0 para a cor original.|
