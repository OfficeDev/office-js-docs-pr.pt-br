...
| Exibições de planilha nomeadas | Oferece controle programático de exibições de planilha por usuário. | [NamedSheetView](/javascript/api/excel/excel.namedsheetview) |
| Tarefas | Transformar comentários em tarefas atribuídas aos usuários. | [Tarefa](/javascript/api/excel/excel.task) |

## <a name="api-list"></a>Lista de APIs

A tabela a seguir lista as APIs JavaScript do Excel atualmente em visualização. Para ver uma lista completa de todas as APIs JavaScript do Excel (incluindo APIs de visualização e APIs lançadas anteriormente), confira todas as [APIs JavaScript do Excel.](/javascript/api/excel?view=excel-js-preview&preserve-view=true)
...
||[periodicRefreshInterval](/javascript/api/excel/excel.linkeddatatype#periodicrefreshinterval)|A frequência, em segundos, em que o tipo de dados vinculados é atualizado se `refreshMode` estiver definido como "Periódico".|
...
|[NamedSheetViewCollection](/javascript/api/excel/excel.namedsheetviewcollection)|[add(name: string)](/javascript/api/excel/excel.namedsheetviewcollection#add-name-)|Cria uma nova exibição de planilha com o nome determinado.|
...
||[exit()](/javascript/api/excel/excel.namedsheetviewcollection#exit--)|Sai do atual exibição de planilha ativa.|
...
||[showFieldHeaders](/javascript/api/excel/excel.pivotlayout#showfieldheaders)|Especifica se a Tabela Dinâmica exibe os headers de campo (legendas de campo e lista de lista de filtros).|
