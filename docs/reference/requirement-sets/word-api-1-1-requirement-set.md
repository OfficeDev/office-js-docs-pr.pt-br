...
||[paragraphs](/javascript/api/word/word.contentcontrol#paragraphs)|Obtém a coleção de objetos de parágrafo no controle de conteúdo.|
...
||[tipo](/javascript/api/word/word.contentcontrol#type)|Obtém o tipo de controle de conteúdo.|
...
|[Document](/javascript/api/word/word.document)|[body](/javascript/api/word/word.document#body)|Obtém o objeto body do documento principal.|
...
||[getSelection()](/javascript/api/word/word.document#getSelection__)|Obtém a seleção atual do documento.|
...
|[Section](/javascript/api/word/word.section)|[body](/javascript/api/word/word.section#body)|Obtém o objeto body da seção.|
||[getFooter(type: Word.HeaderFooterType)](/javascript/api/word/word.section#getFooter_type_)|Obtém um dos rodapés da seção.|
