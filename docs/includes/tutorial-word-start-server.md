Se o servidor Web local já estiver em execução e se o suplemento já estiver carregado no Word, vá para a etapa 2. Caso contrário, inicie o servidor Web local e Sideload seu suplemento: 
