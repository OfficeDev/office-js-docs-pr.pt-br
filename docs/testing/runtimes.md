...
- **Runtime do navegador**: inclui todos os recursos de um runtime somente JavaScript e adiciona um mecanismo [](https://developer.mozilla.org/docs/Glossary/Rendering_engine) de renderização que renderiza HTML.
