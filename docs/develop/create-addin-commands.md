...
- <span data-ttu-id="c7ba1-p103">Executar a??es quando seu comando de suplemento for escolhido. ? poss?vel:</span><span class="sxs-lookup"><span data-stu-id="c7ba1-p103">Perform actions when your add-in command is chosen. You can:</span></span>
  ...
  - <span data-ttu-id="c7ba1-113">Mostrar um ou mais suplementos de painel de tarefa com os quais os usu?rios podem interagir.</span><span class="sxs-lookup"><span data-stu-id="c7ba1-113">Show one or more task pane add-ins for users to interact with.</span></span> <span data-ttu-id="c7ba1-114">Dentro do suplemento de painel de tarefa, ? poss?vel exibir HTML que use a malha da interface do usu?rio do Office para criar uma interface do usu?rio personalizada.</span><span class="sxs-lookup"><span data-stu-id="c7ba1-114">Inside your task pane add-in, you can display HTML that uses Office UI Fabric to create a custom UI.</span></span>
     ...
     <span data-ttu-id="c7ba1-115">*ou*</span><span class="sxs-lookup"><span data-stu-id="c7ba1-115">*or*</span></span> 
      
  - <span data-ttu-id="c7ba1-116">Executar c?digo JavaScript, que normalmente ? executado sem exibir qualquer interface do usu?rio.</span><span class="sxs-lookup"><span data-stu-id="c7ba1-116">Run JavaScript code, which normally runs without displaying any UI.</span></span>
      
<span data-ttu-id="c7ba1-117">Este artigo descreve como editar seu manifesto para definir comandos de suplemento.</span><span class="sxs-lookup"><span data-stu-id="c7ba1-117">This article describes how to edit your manifest to define add-in commands.</span></span> <span data-ttu-id="c7ba1-118">O diagrama a seguir mostra a hierarquia de elementos usada para definir comandos de suplemento.</span><span class="sxs-lookup"><span data-stu-id="c7ba1-118">The following diagram shows the hierarchy of elements used to define add-in commands.</span></span> <span data-ttu-id="c7ba1-119">Descrevemos esses elementos com mais detalhes neste artigo.</span><span class="sxs-lookup"><span data-stu-id="c7ba1-119">These elements are described in more detail in this article.</span></span> 
      
<span data-ttu-id="c7ba1-120">A imagem a seguir representa uma vis?o geral dos elementos dos comandos de suplemento no manifesto.</span><span class="sxs-lookup"><span data-stu-id="c7ba1-120">The following image is an overview of add-in commands elements in the manifest.</span></span> 
<span data-ttu-id="c7ba1-121">![Vis?o geral dos elementos dos comandos de suplemento no manifesto](../images/version-overrides.png)</span><span class="sxs-lookup"><span data-stu-id="c7ba1-121">![Overview of add-in commands elements in the manifest](../images/version-overrides.png)</span></span>
 
## <a name="step-1-start-from-a-sample"></a><span data-ttu-id="c7ba1-122">Etapa 1: iniciar usando uma amostra</span><span class="sxs-lookup"><span data-stu-id="c7ba1-122">Step 1: Start from a sample</span></span>
...
|<span data-ttu-id="c7ba1-150">**Elemento**</span><span class="sxs-lookup"><span data-stu-id="c7ba1-150">**Element**</span></span>|<span data-ttu-id="c7ba1-151">**Descri??o**</span><span class="sxs-lookup"><span data-stu-id="c7ba1-151">**Description**</span></span>|
|:-----|:-----|
...
|<span data-ttu-id="c7ba1-367">**Recurso**</span><span class="sxs-lookup"><span data-stu-id="c7ba1-367">**Resource**</span></span>|<span data-ttu-id="c7ba1-368">**Descri??o**</span><span class="sxs-lookup"><span data-stu-id="c7ba1-368">**Description**</span></span>|
|:-----|:-----|
