...
|:-----|:-----|
|**Restrito**|Os métodos do objeto [Settings](../../reference/shared/settings.md) e o método [Document.getActiveViewAsync](../../reference/shared/document.getactiveviewasync.md). Esse é o nível de permissão mínimo que pode ser solicitado por um suplemento de conteúdo ou de painel de tarefas.|
