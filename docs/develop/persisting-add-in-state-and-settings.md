...
### <a name="removing-a-roaming-setting"></a><span data-ttu-id="be7c2-218">Remover uma configuração móvel</span><span class="sxs-lookup"><span data-stu-id="be7c2-218">Removing a roaming setting</span></span>
