...
3.  **Objetos para trabalhar com recursos específicos.** Para trabalhar com recursos específicos da API, use as seguintes objetos e métodos:
    ...
    - Os métodos do objeto [Bindings](../../reference/shared/bindings.bindings.md) para criar ou obter associações e os métodos e propriedades do objeto [Binding](http://dev.office.com/reference/add-ins/shared/binding) para trabalhar com dados.
