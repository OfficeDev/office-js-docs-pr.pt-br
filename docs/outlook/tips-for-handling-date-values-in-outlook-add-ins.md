...
description: A Office JavaScript usa o objeto Data javascript para a maioria do armazenamento e recuperação de datas e horas.
ms.date: 10/31/2019
...
A limitação javaScript acima acima tem uma implicação para você, quando você usa Office API JavaScript do Office para lidar com valores de data ou hora em complementos do Outlook que são executados em um cliente Outlook e em dispositivos móveis ou Outlook na Web ou Outlook na Web.
...
Como um cliente Outlook rich usa o fuso horário do computador cliente e a interface do usuário do Outlook na Web e dispositivos móveis usa o fuso horário do EAC, o horário local para o mesmo complemento instalado para a mesma caixa de correio pode ser diferente ao ser executado em um cliente Outlook rico e em dispositivos móveis ou Outlook na Web ou em dispositivos móveis. Como desenvolvedor de suplementos do Outlook, você deve fornecer valores de data de entrada e saída de forma que sejam sempre consistentes com o fuso horário que o usuário espera no cliente correspondente.
