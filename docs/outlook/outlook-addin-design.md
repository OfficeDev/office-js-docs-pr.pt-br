...
4. **Use sua marca de forma sensata**
   ...
   Valorizamos excelentes usos de marca e sabemos que é importante fornecer aos usuários uma experiência exclusiva. Mas sentimos que a melhor maneira de garantir o sucesso de seu suplemento é criar uma experiência intuitiva que incorpora de forma sutil os elementos de sua marca versus a exibição de elementos persistentes ou evidentes da marca que apenas desviam a atenção do usuário na movimentação pelo seu sistema de uma forma sem complicações. 
...
**Um exemplo de página de entrada e inscrição no iOS**

![Exemplos de páginas de entrada e inscrição no iOS](../images/outlook-mobile-design-signin.png)

**Um exemplo de página de entrada no Android**
