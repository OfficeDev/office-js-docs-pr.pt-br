...
2. Veja o serviço **ProjectData** usando seu navegador com a seguinte URL: **http://NomeDoServidor/NomeDoServidorDoProject/_api/ProjectData/**. Por exemplo, se a instância do Project Web App for `http://MyServer/pwa`, o navegador mostrará os seguintes resultados:
