...
- O evento [initialize](../../reference/shared/office.initialize.md) do objeto **Office**, que é gerado quando o contexto do suplemento é inicializado e fornece acesso a uma instância de objeto [Document](http://dev.office.com/reference/add-ins/shared/document) que representa o documento com o qual o suplemento está interagindo.
