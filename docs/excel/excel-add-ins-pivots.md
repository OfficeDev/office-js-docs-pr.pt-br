...
Este artigo fornece exemplos de código para cenários comuns. O [Excel OpenSpec](https://github.com/OfficeDev/office-js-docs/tree/ExcelJs_OpenSpec/reference/excel) fornece documentação de referência completo para esse recurso de visualização. 

Para enriquecer a compreensão da API de tabela dinâmica, veja [**Tabela dinâmica**](https://github.com/OfficeDev/office-js-docs/blob/ExcelJs_OpenSpec/reference/excel/pivottable.md) e [**Coleção de tabelas dinâmicas**](https://github.com/OfficeDev/office-js-docs/blob/ExcelJs_OpenSpec/reference/excel/pivottablecollection.md).

> [!NOTE]
> Estes exemplos usam APIs disponíveis atualmente somente na visualização pública (beta). Estes exemplos exigem compilações de versão prévia para serem executados. Use a biblioteca beta de [Office.js CDN](https://appsforoffice.microsoft.com/lib/beta/hosted/office.js) ou entre no programa do [Office Insider](https://products.office.com/office-insider). Recursos de tabela dinâmica estão atualmente disponíveis na compilação 16.0.10801.20004.
