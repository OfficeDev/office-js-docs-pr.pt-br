...
| <a href="https://support.office.com/article/CEILINGMATH-function-80f95d2f-b499-4eee-9f16-f795a8e306c8" target="_blank">Função TETO.MAT</a> | FunctionResult | Arredonda um número para cima, para o inteiro mais próximo ou para o múltiplo mais próximo significativo |
...
| <a href="https://support.office.com/article/DOLLAR-function-a6cd05d9-9740-4ad3-a469-8109d18ff611" target="_blank">Função MOEDA</a> | FunctionResult | Converte um número em texto, usando o formato de moeda $ (cifrão) |
...
| <a href="https://support.office.com/article/FLOOR-function-14bb497c-24f2-4e04-b327-b0b4de5a8886" target="_blank">Função ARREDMULTB</a> | FunctionResult | Arredonda um número para baixo até zero |
...
| <a href="https://support.office.com/article/FORECAST-function-50ca49c9-7b40-4892-94e4-7ad38bbeda99" target="_blank">Função PREVISÃO</a> | FunctionResult | Retorna um valor ao longo de uma tendência linear |
| <a href="https://support.office.com/article/FORECASTETS-function-897a2fe9-6595-4680-a0b0-93e0308d5f6e" target="_blank">Função PREVISÃO.ETS</a> | FunctionResult | Retorna um valor futuro com base em valores existentes (históricos), usando a versão AAA do algoritmo de Suavização Exponencial (ETS) |
| <a href="https://support.office.com/article/FORECASTETSCONFINT-function-897a2fe9-6595-4680-a0b0-93e0308d5f6e" target="_blank">Função PREVISÃO.ETS.CONFINT</a> | FunctionResult | Retorna um intervalo de confiança para o valor de previsão na data de destino especificada |
| <a href="https://support.office.com/article/FORECASTETSSEASONALITY-function-897a2fe9-6595-4680-a0b0-93e0308d5f6e" target="_blank">Função PREVISÃO.ETS.SAZONALIDADE</a> | FunctionResult | Retorna o comprimento do padrão repetitivo que Excel detecta para a série temporal especificada |
| <a href="https://support.office.com/article/FORECASTETSSTAT-function-897a2fe9-6595-4680-a0b0-93e0308d5f6e" target="_blank">Função PREVISÃO.ETS.STAT</a> | FunctionResult | Retorna um valor estatístico como resultado de previsão de série temporal |
| <a href="https://support.office.com/article/FORECASTLINEAR-function-897a2fe9-6595-4680-a0b0-93e0308d5f6e" target="_blank">Função PREVISÃO.LINEAR</a> | FunctionResult | Retorna um valor futuro com base em valores existentes |
...
| <a href="https://support.office.com/article/PROB-function-9ac30561-c81c-4259-8253-34f0a238fc49" target="_blank">Função PROB</a> | FunctionResult | Retorna a probabilidade de valores em um intervalo estarem entre dois limites |
...
| <a href="https://support.office.com/article/RTD-function-e0cc001a-56f0-470a-9b19-9455dc0eb593" target="_blank">Função RTD</a> | FunctionResult | Recupera dados em tempo real de um programa compatível com a automação COM |
...
- [Objeto de funções de planilha (API JavaScript para Excel)](https://docs.microsoft.com/javascript/api/excel/excel.worksheet?view=office-js)
