...
Para saber mais sobre como começar a criar seu suplemento do Office, teste nossos [Guias de Início Rápido de cinco minutos](https://docs.microsoft.com/office/dev/add-ins/). Você pode começar a criar suplementos imediatamente usando o Visual Studio ou outro editor. 
