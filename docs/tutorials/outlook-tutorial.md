...
1. Localize a matriz `plugins` dentro do objeto `config`. Na matriz `patterns` do objeto `new CopyWebpackPlugin`, adicione novas entradas para **taskpane.css** e **dialog.css**.
